...
-- SPAWNPOSITION
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.SpawnPosition(Select)
    local Slot = "0"
    local Checks = 0
    local Selected = {}
    local Position = nil
...
-- CREATEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.CreateVehicle(Model, Network, Engine, Health, Customize, Windows, Tyres, Brakes)
...
-- SEARCHBLIP
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.SearchBlip(Coords)
...
-- STOPHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.StopHotwired(Vehicle)
    Hotwired = false
...
-- UPDATEHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.UpdateHotwired(Status)
    Hotwired = Status
end
...
-- REGISTERDECORS
-----------------------------------------------------------------------------------------------------------------------------------------
function Lume.RegisterDecors(Vehicle)
    SetVehicleHasBeenOwnedByPlayer(Vehicle, true)
    SetVehicleNeedsToBeHotwired(Vehicle, false)
    DecorSetInt(Vehicle, "Player_Vehicle", -1)
    SetVehRadioStation(Vehicle, "OFF")
